...
** Para a equação apresentada em relação a o efeito da Legibilidade da norma da CPC sobre Legibilidade da nota explicativa (p-value 0.019 **p<0.05), observa-se um efeito positivo e significativo de pelo menos
** 5% para as empresas estudadas. Assim, indicado que aumentos nos níveis de legibilidade da norma da CPC provocariam crescimentos no I.L.Nota Explicativa das empresas. 
**CAPIT(p-value 0.033 **p<0.05) tempo de negociação na bolsa. Tem-se efeito positivo e significativo sobre a o indice de legibilidade da nota explicativa. Tal resultado retrata que aumentos
** no tempo de negocigação em bolsa de valores provocariam crescimentos no indice de legibilidade da notas explicativas.
**ADR(p-value 0.069 *p<0.1) Se negocia ação na bolsa


**wlTAM para a variável wlTAM tem-se um efeito negativo e não significativo sobre o indice de legibilidade da nota explicativa. Esperava-se um relação positiva entre o tamanho da empresa e o Indice de Leg.NotaEx.
** Um resultado que contrapoem alguns estudos ... 'justificar ... '

**wsCOMPLEX** tem-se um efeito positivo e não significativo sobre o indice de legibilidade da nota explicativa
